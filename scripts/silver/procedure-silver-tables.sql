/*
==========================================================================================
Store Procedure: Load Silver Tables (Bronze -> Silver)
==========================================================================================
Script Purpose :
	This store procedure performs the ETL process to populate the 'silver' schema tables
	from 'bronze' schema.
  Action Performed :
	1. Truncates Silver tables to avoid duplication of data.
	2. Inserts Cleaned & Transformed data from Bronze tables to Silver tables.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '======================================================================';
		PRINT 'Loading Data for Silver Layer';
		PRINT '======================================================================';
		...
		SELECT
			...
			CASE
				...
				-- Explicit conversion from int to date is now allowed in SQL Server
				-- That's why first converted to string, then to date
			END AS sls_order_dt,
			CASE
		...
		PRINT '======================================================================';
		PRINT 'Loading Data for Silver Layer is Completed';
	...
	BEGIN CATCH
		PRINT '======================================================================';
		PRINT 'ERROR OCCURRED DURING LOADING DATA FOR SILVER LAYER';
